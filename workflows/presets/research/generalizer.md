...
| `.plurics/shared/data/results/{{HYPOTHESIS_ID}}-result.json` | Original result |
| `.plurics/shared/data/audit/{{HYPOTHESIS_ID}}-falsification.json` | Falsification report |
...
| `.plurics/shared/data/signals/generalizer-{{HYPOTHESIS_ID}}.done` | Signal |
